...
RUN  for i in designate-tempest-plugin magnum-tempest-plugin neutron-tempest-plugin manila-tempest-plugin keystone-tempest-plugin murano-tempest-plugin heat-tempest-plugin tempest-horizon; do \
